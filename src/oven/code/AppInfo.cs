using Websolute.BOM.Oven.Extensions.Data.Cache;
using Websolute.BOM.Oven.Extensions.Data;
...
public class AppInfo : Websolute.BOM.Oven.Core.AppInfo<AppConfig>
{
  ...
  public static TConfig Gateway<TConfig>(int numRetry = 0) where TConfig : class, AppConfig.IGatewayBase
  {
    try
    {
      ...
      var gateway = Websolute.BOM.Oven.Shared.Serialization.Util.As<TConfig>(
